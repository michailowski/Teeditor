...
{
    internal class MapEnvelopePointPositionFactory : MapItemFactory
    {
        private TimeSpan _time = TimeSpan.Zero;

        public override MapItem Create()
        {
            var mapEnvelopePoint = new MapEnvelopePointPosition(_time);
        ...
        {
            MapEnvelopePointPosition mapEnvelopePoint = null;
        ...
        private void TryCreate_v1(out MapEnvelopePointPosition mapEnvelopePoint, IMapItemDTO mapItemDTO, MapFilePayload payload)
        {
            ...
            mapEnvelopePoint = new MapEnvelopePointPosition(time, mapEnvelopePointDTO.values);
            mapEnvelopePoint.CurveType = (CurveType)mapEnvelopePointDTO.curveType;
        }

        private void TryCreate_v2(ref MapEnvelopePointPosition mapEnvelopePoint, IMapItemDTO mapItemDTO, MapFilePayload payload)
        {
            ...
            mapEnvelopePoint = new MapEnvelopePointPosition(
                time,
